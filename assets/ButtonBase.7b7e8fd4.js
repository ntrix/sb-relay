...
`),b.rippleVisible,ot,ee,({theme:e})=>e.transitions.easing.easeInOut,b.ripplePulsate,({theme:e})=>e.transitions.duration.shorter,b.child,b.childLeaving,rt,ee,({theme:e})=>e.transitions.easing.easeInOut,b.childPulsate,st,({theme:e})=>e.transitions.easing.easeInOut),lt=a.exports.forwardRef(d(function(r,i){const l=me({props:r,name:"MuiTouchRipple"}),{center:n=!1,classes:t={},className:o}=l,c=te(l,tt),[u,p]=a.exports.useState([]),h=a.exports.useRef(0),x=a.exports.useRef(null);a.exports.useEffect(()=>{x.current&&(x.current(),x.current=null)},[u]);const g=a.exports.useRef(!1),w=a.exports.useRef(null),m=a.exports.useRef(null),R=a.exports.useRef(null);a.exports.useEffect(()=>()=>{clearTimeout(w.current)},[]);const j=a.exports.useCallback(f=>{const{pulsate:M,rippleX:T,rippleY:L,rippleSize:U,cb:O}=f;p(y=>[...y,P(at,{classes:{ripple:E(t.ripple,b.ripple),rippleVisible:E(t.rippleVisible,b.rippleVisible),ripplePulsate:E(t.ripplePulsate,b.ripplePulsate),child:E(t.child,b.child),childLeaving:E(t.childLeaving,b.childLeaving),childPulsate:E(t.childPulsate,b.childPulsate)},timeout:ee,pulsate:M,rippleX:T,rippleY:L,rippleSize:U},h.current)]),h.current+=1,x.current=O},[t]),I=a.exports.useCallback((f={},M={},T)=>{const{pulsate:L=!1,center:U=n||M.pulsate,fakeElement:O=!1}=M;if((f==null?void 0:f.type)==="mousedown"&&g.current){g.current=!1;return}(f==null?void 0:f.type)==="touchstart"&&(g.current=!0);const y=O?null:R.current,S=y?y.getBoundingClientRect():{width:0,height:0,left:0,top:0};let v,D,k;if(U||f===void 0||f.clientX===0&&f.clientY===0||!f.clientX&&!f.touches)v=Math.round(S.width/2),D=Math.round(S.height/2);else{const{clientX:$,clientY:V}=f.touches?f.touches[0]:f;v=Math.round($-S.left),D=Math.round(V-S.top)}if(U)k=Math.sqrt((2*S.width**2+S.height**2)/3),k%2===0&&(k+=1);else{const $=Math.max(Math.abs((y?y.clientWidth:0)-v),v)*2+2,V=Math.max(Math.abs((y?y.clientHeight:0)-D),D)*2+2;k=Math.sqrt($**2+V**2)}f!=null&&f.touches?m.current===null&&(m.current=()=>{j({pulsate:L,rippleX:v,rippleY:D,rippleSize:k,cb:T})},w.current=setTimeout(()=>{m.current&&(m.current(),m.current=null)},nt)):j({pulsate:L,rippleX:v,rippleY:D,rippleSize:k,cb:T})},[n,j]),z=a.exports.useCallback(()=>{I({},{pulsate:!0})},[I]),_=a.exports.useCallback((f,M)=>{if(clearTimeout(w.current),(f==null?void 0:f.type)==="touchend"&&m.current){m.current(),m.current=null,w.current=setTimeout(()=>{_(f,M)});return}m.current=null,p(T=>T.length>0?T.slice(1):T),x.current=M},[]);return a.exports.useImperativeHandle(i,()=>({pulsate:z,start:I,stop:_}),[z,I,_]),P(it,Y({className:E(t.root,b.root,o),ref:R},c,{children:P(Qe,{component:null,exit:!0,children:u})}))},"TouchRipple")),ut=lt;function ct(e){return Oe("MuiButtonBase",e)}d(ct,"getButtonBaseUtilityClass");const pt=be("MuiButtonBase",["root","disabled","focusVisible"]),dt=pt,ft=["action","centerRipple","children","className","component","disabled","disableRipple","disableTouchRipple","focusRipple","focusVisibleClassName","LinkComponent","onBlur","onClick","onContextMenu","onDragLeave","onFocus","onFocusVisible","onKeyDown","onKeyUp","onMouseDown","onMouseLeave","onMouseUp","onTouchEnd","onTouchMove","onTouchStart","tabIndex","TouchRippleProps","touchRippleRef","type"],ht=d(e=>{const{disabled:r,focusVisible:i,focusVisibleClassName:l,classes:n}=e,o=Ke({root:["root",r&&"disabled",i&&"focusVisible"]},ct,n);return i&&l&&(o.root+=` ${l}`),o},"useUtilityClasses"),mt=ne("button",{name:"MuiButtonBase",slot:"Root",overridesResolver:(e,r)=>r.root})({display:"inline-flex",alignItems:"center",justifyContent:"center",position:"relative",boxSizing:"border-box",WebkitTapHighlightColor:"transparent",backgroundColor:"transparent",outline:0,border:0,margin:0,borderRadius:0,padding:0,cursor:"pointer",userSelect:"none",verticalAlign:"middle",MozAppearance:"none",WebkitAppearance:"none",textDecoration:"none",color:"inherit","&::-moz-focus-inner":{borderStyle:"none"},[`&.${dt.disabled}`]:{pointerEvents:"none",cursor:"default"},"@media print":{colorAdjust:"exact"}}),bt=a.exports.forwardRef(d(function(r,i){const l=me({props:r,name:"MuiButtonBase"}),{action:n,centerRipple:t=!1,children:o,className:c,component:u="button",disabled:p=!1,disableRipple:h=!1,disableTouchRipple:x=!1,focusRipple:g=!1,LinkComponent:w="a",onBlur:m,onClick:R,onContextMenu:j,onDragLeave:I,onFocus:z,onFocusVisible:_,onKeyDown:f,onKeyUp:M,onMouseDown:T,onMouseLeave:L,onMouseUp:U,onTouchEnd:O,onTouchMove:y,onTouchStart:S,tabIndex:v=0,TouchRippleProps:D,touchRippleRef:k,type:$}=l,V=te(l,ft),K=a.exports.useRef(null),C=a.exports.useRef(null),ge=Z(C,k),{isFocusVisibleRef:ie,onFocus:xe,onBlur:Re,ref:Me}=Ye(),[F,A]=a.exports.useState(!1);p&&F&&A(!1),a.exports.useImperativeHandle(n,()=>({focusVisible:()=>{A(!0),K.current.focus()}}),[]);const[q,Te]=a.exports.useState(!1);a.exports.useEffect(()=>{Te(!0)},[]);const ye=q&&!h&&!p;a.exports.useEffect(()=>{F&&g&&!h&&q&&C.current.pulsate()},[h,g,F,q]);function B(s,le,_e=x){return H(ue=>(le&&le(ue),!_e&&C.current&&C.current[s](ue),!0))}d(B,"useRippleHandler");const Ce=B("start",T),Ee=B("stop",j),ve=B("stop",I),Ve=B("stop",U),Be=B("stop",s=>{F&&s.preventDefault(),L&&L(s)}),Pe=B("start",S),we=B("stop",O),Se=B("stop",y),De=B("stop",s=>{Re(s),ie.current===!1&&A(!1),m&&m(s)},!1),ke=H(s=>{K.current||(K.current=s.currentTarget),xe(s),ie.current===!0&&(A(!0),_&&_(s)),z&&z(s)}),J=d(()=>{const s=K.current;return u&&u!=="button"&&!(s.tagName==="A"&&s.href)},"isNonNativeButton"),Q=a.exports.useRef(!1),Le=H(s=>{g&&!Q.current&&F&&C.current&&s.key===" "&&(Q.current=!0,C.current.stop(s,()=>{C.current.start(s)})),s.target===s.currentTarget&&J()&&s.key===" "&&s.preventDefault(),f&&f(s),s.target===s.currentTarget&&J()&&s.key==="Enter"&&!p&&(s.preventDefault(),R&&R(s))}),$e=H(s=>{g&&s.key===" "&&C.current&&F&&!s.defaultPrevented&&(Q.current=!1,C.current.stop(s,()=>{C.current.pulsate(s)})),M&&M(s),R&&s.target===s.currentTarget&&J()&&s.key===" "&&!s.defaultPrevented&&R(s)});let W=u;W==="button"&&(V.href||V.to)&&(W=w);const X={};W==="button"?(X.type=$===void 0?"button":$,X.disabled=p):(!V.href&&!V.to&&(X.role="button"),p&&(X["aria-disabled"]=p));const Fe=Z(Me,K),Ne=Z(i,Fe),ae=Y({},l,{centerRipple:t,component:u,disabled:p,disableRipple:h,disableTouchRipple:x,focusRipple:g,tabIndex:v,focusVisible:F}),Ie=ht(ae);return ze(mt,Y({as:W,className:E(Ie.root,c),ownerState:ae,onBlur:De,onClick:R,onContextMenu:Ee,onFocus:ke,onKeyDown:Le,onKeyUp:$e,onMouseDown:Ce,onMouseLeave:Be,onMouseUp:Ve,onDragLeave:ve,onTouchEnd:we,onTouchMove:Se,onTouchStart:Pe,ref:Ne,tabIndex:p?-1:v,type:$},X,V,{children:[o,ye?P(ut,Y({ref:ge,center:t},D)):null]}))},"ButtonBase")),Vt=bt;export{Vt as B};
//# sourceMappingURL=ButtonBase.7b7e8fd4.js.map
